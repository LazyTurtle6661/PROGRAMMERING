...
let colors = ['blue', 'green', 'green', 'blue', 'green',' blue']
...
// state variabel til at styre logikken
let state = 'setup'

//variabel der bestemmer hvilken farve der vises/skal trykkes på nu
let currentColor = 0
...
function draw(){
  ...
  if(state == 'colors'){
    header.html(`Husk farver: ${currentColor + 1}`)
